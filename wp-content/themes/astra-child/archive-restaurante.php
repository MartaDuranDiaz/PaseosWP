<?php
/**
 * Archive Restaurante (CPT: restaurante)
 * Archivo: archive-restaurante.php
 */
...
<main class="ps-wrap ps-archive">
  ...
  <!-- HERO DEL LISTADO -->
  <header class="ps-archive-hero" aria-label="Listado de restaurantes">
    <div class="ps-archive-hero__inner">
      <h1 class="ps-archive-title">Restaurantes</h1>
      <p class="ps-archive-lead">Descubre los mejores restaurantes y accede al detalle para reservar mesa.</p>
    </div>
  </header>

  <!-- GRID TARJETAS -->
  <section class="ps-grid-archive" aria-label="Tarjetas de restaurantes">
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <article class="ps-card ps-card--archive">
          <a class="ps-card__media" href="<?php echo esc_url($permalink); ?>" aria-label="<?php echo esc_attr($title); ?>">
            ...
            <span class="ps-card__badge">Restaurante</span>
          </a>
          ...
          <div class="ps-card__body">
            ...
            <div class="ps-card__actions">
              ...
              <a class="ps-btn ps-btn--ghost" href="<?php echo esc_url($permalink); ?>#reserva">Reservar mesa</a>
            </div>
          </div>
        </article>
    ...
    <?php else: ?>
      ...
      <div class="ps-empty">
        <h2 class="ps-h2">Aún no hay restaurantes publicados</h2>
        <p class="ps-muted">Cuando se publique el primer restaurante, aparecerá automáticamente aquí.</p>
      </div>
